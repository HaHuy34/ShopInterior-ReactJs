                  ...
                  <div className="container">
                    <div className="row">
                      <div className="col">
                        ...
                        <p id="buyerName">{buyerInfo && buyerInfo.name}</p>
                        <p id="buyerEmail">{buyerInfo && buyerInfo.email}</p>
                      ...
                      <div className="col col--sm--two">
                        ...
                        <p id="shippingName">{buyerInfo && buyerInfo.name}</p>
