...
const Blog = () => {
  const [data, loading] = useGetApi(
    // "https://api-shop-interior.vercel.app/blog"
                ...
                >
                  <div className="blog-item">
                    <Link to={`${blog.id}`}>
                      ...
                      >
                        <div className="post-date">
                          ...
                          <br />
                          <span className="post-month">JUL</span>
                        </div>
                    ...
                    <div className="blog-content">
                      <h3 className="title-content">{blog.title}</h3>
                      <div className="entry-meta">
                        <ul className="entr-list">
                          <li className="created-by">By</li>
                          <li className="avatar">
                            <img src={blog.avatar} alt="" />
                          </li>
                          <li className="name-cr">S. Rogers</li>
                          <li className="mess">
                            <div className="mess-main">
                              ...
                              <span className="mess-lable">1</span>
                            </div>
                          </li>
                          <li className="link-cr">
                            <i className="fa-solid fa-share-nodes"></i>
                          </li>
                        </ul>
                      </div>
                      <div className="entry-content">
                        {blog.description.moreInformationHeader}
                      </div>
